...
{/if}
<div class="gm-note-card-content">
	{#if !editMode && (resolvedPath || config.source)}
		<button class="gm-inline-icon-btn gm-note-open" title="Open source note" onclick={openSource}>
